...
const ItemContainer = props =>
  <div key={props.key} class="w-20-ns w-50 mv3-ns mh3-ns">
...
const PortfolioPage = ({ data }) =>
  <div class="fl w-100">
    <div class="fl w-100 ph5 tc mb5-ns mb3">
      <img src={Folder} alt="My Work" width={135} class="mr4-ns" />
      <img src={LinkImage} alt="and links to my work" width={135} />
